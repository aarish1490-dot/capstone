...
<h2 class="page-title">Almost there!</h2>
<p class="page-subtitle">Your cart is ready to become an order.</p>
        ...
        <table>
            ...
            <c:forEach var="line" items="${cart.lines}">
                <tr>
                    ...
                    <td><c:out value="${line.product.sellerName}"/></td>
    ...
    <div>
        ...
        <div class="form-card" style="margin-top:18px;">
            ...
            <form action="${ctx}/checkout" method="post" id="checkoutForm">
                ...
                <button type="submit" class="btn" id="checkoutBtn" style="padding:12px 28px;">Confirm Mock Payment</button>
