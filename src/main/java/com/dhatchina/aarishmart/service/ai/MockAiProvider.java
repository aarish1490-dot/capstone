    ...
    private String replyFor(String message) {
        ...
        if (text.contains("search") || text.contains("find") || text.contains("filter")
            ...
            return "Visit the Products page to search by keyword and filter by category. "
                    + "AarishMart stocks Electronics, Accessories, Books, Clothing and Home items.";
        }
        ...
        if (text.contains("what is") || text.contains("about") || text.contains("help")
                || text.contains("where")) {
            return "AarishMart is a multi-seller e-commerce marketplace. You can browse products from multiple "
        ...
        return "I'm the AarishMart assistant, focused on helping with shopping here. " + HELP_LINE;
    }
}